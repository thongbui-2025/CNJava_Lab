    ...
    <form method="post" action="/register">
        <table>
            ...
            <tr>
                ...
                <td>
                    <div><input type="checkbox" name="favorite_ides" value="Visual Studio Code"> Visual Studio Code</div>
                    <div><input type="checkbox" name="favorite_ides" value="Sublime Text"> Sublime Text</div>
                    <div><input type="checkbox" name="favorite_ides" value="Eclipse"> Eclipse</div>
                    <div><input type="checkbox" name="favorite_ides" value="Atom"> Atom</div>
                    <div><input type="checkbox" name="favorite_ides" value="Intelij Idea"> Intelij Idea</div>
                </td>
            </tr>
            <tr>
                <td>TOEIC Score</td>
